    ...
    def make_graph(self, form, dino, **kwargs):
        ...
        **kwargs : Can specify graph used for the blue or green points. 
        ...
        #Else if g_points in kwargs uses them
            ...
            g_x_data = self.x_collated[kwargs['b_points']]
            g_y_data = self.y_collated[kwargs['b_points']]
        ...
        #plot green points
        ax.scatter(g_x_data, g_y_data, s=80, facecolors='none', edgecolors='green')
        ...
        for i in range(len(b_x_data)):
            ...
            if quad in cross_quadrants:
                ax.scatter(x, y, s=80, marker='x', facecolors='blue')
            else:
                ax.scatter(x, y, s=80, facecolors='none', edgecolors='blue')
