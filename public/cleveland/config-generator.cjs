...
const originalConfig = require('./config-cleveland.json'); // Change the path to your original config file
// Function to generate random data for objects that have a 'data' property
