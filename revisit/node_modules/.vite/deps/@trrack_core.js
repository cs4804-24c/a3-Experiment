...
var N = class {
  static get() {
    ...
    for (; this.ids.has(t); )
      t = Ne();
    return this.ids.set(t, true), t;
  }
};
N.ids = /* @__PURE__ */ new Map();
function P(e) {
  return "parent" in e;
}
function Mt(e) {
...
function C(e, t, r) {
  r === void 0 && (r = false), D(e) === 0 ? (r ? Object.keys : Oe)(e).forEach(function(n) {
...
function ve(e) {
  ...
  for (var r = Oe(t), n = 0; n < r.length; n++) {
    var o = r[n], a = t[o];
    a.writable === false && (a.writable = true, a.configurable = true), (a.get || a.set) && (t[o] = { configurable: true, writable: true, enumerable: a.enumerable, value: e[o] });
  }
  return Object.create(Object.getPrototypeOf(e), t);
}
function ye(e, t) {
  return t === void 0 && (t = false), ge(e) || M(e) || !S(e) || (D(e) > 1 && (e.set = e.add = e.clear = e.delete = tt), Object.freeze(e), t && C(e, function(r, n) {
    return ye(n, true);
  }, true)), e;
}
function tt() {
...
function Te() {
  return {}.NODE_ENV === "production" || F || g(0), F;
}
function te(e, t) {
...
function re(e, t) {
  ...
  return t.h.g || T("ES5").S(t, e, n), n ? (r[_].P && (W(t), g(4)), S(e) && (e = Q(t, e), t.l || G(t, e)), t.u && T("Patches").M(r[_].t, e, t.u, t.s)) : e = Q(t, r, []), W(t), t.u && t.v(t.u, t.s), e !== me ? e : void 0;
}
function Q(e, t, r) {
  if (ge(t))
    return t;
  var n = t[_];
  if (!n)
    return C(t, function(a, u) {
      return De(e, n, t, a, u, r);
    }, true), t;
  if (n.A !== e)
    return t;
  if (!n.P)
    return G(e, n.t, true), n.t;
  if (!n.I) {
    n.I = true, n.A._--;
    var o = n.i === 4 || n.i === 5 ? n.o = ve(n.k) : n.o;
    C(n.i === 3 ? new Set(o) : o, function(a, u) {
      return De(e, n, o, a, u, r);
    }), G(e, o, false), r && e.u && T("Patches").R(n, r, e.u, e.s);
  }
  return n.o;
}
function De(e, t, r, n, o, a) {
  if ({}.NODE_ENV !== "production" && o === r && g(5), M(o)) {
    var u = Q(e, o, a && t && t.i !== 3 && !k(t.D, n) ? a.concat(n) : void 0);
    if (Ue(r, n, u), !M(u))
      return;
    e.m = false;
  }
...
function G(e, t, r) {
  r === void 0 && (r = false), e.h.F && e.m && ye(t, r);
}
function ne(e, t) {
  var r = e[_];
  return (r ? I(r) : e)[t];
...
function ie(e) {
  e.P || (e.P = true, e.l && ie(e.l));
}
function oe(e) {
  e.o || (e.o = ve(e.t));
}
function ue(e, t, r) {
  var n = X(t) ? T("MapSet").N(t, r) : Z(t) ? T("MapSet").T(t, r) : e.g ? function(o, a) {
    var u = Array.isArray(o), l = { i: u ? 1 : 0, A: a ? a.A : Te(), P: false, I: false, D: {}, l: a, t: o, k: null, o: null, j: null, C: false }, f = l, c = se;
    u && (f = [l], c = x);
    var i = Proxy.revocable(f, c), s = i.revoke, h = i.proxy;
    return l.k = h, l.j = s, h;
  }(t, r) : T("ES5").J(t, r);
...
function at() {
  ...
  rt("Patches", { $: function(n, o) {
    return o.forEach(function(a) {
      for (var u = a.path, l = a.op, f = n, c = 0; c < u.length - 1; c++) {
        var i = D(f), s = "" + u[c];
        i !== 0 && i !== 1 || s !== "__proto__" && s !== "constructor" || g(24), typeof f == "function" && s === "prototype" && g(24), typeof (f = B(f, s)) != "object" && g(15, u.join("/"));
      }
      var h = D(f), p = e(a.value), d = u[u.length - 1];
      switch (l) {
        case "replace":
          switch (h) {
            case 2:
        ...
        case r:
          switch (h) {
            case 1:
              return d === "-" ? f.push(p) : f.splice(d, 0, p);
            case 2:
              return f.set(d, p);
            case 3:
              return f.add(p);
    ...
    switch (n.i) {
      ...
      case 4:
      case 2:
        return function(l, f, c, i) {
          var s = l.t, h = l.o;
          C(l.D, function(p, d) {
            var v = B(s, p), w = B(h, p), A = d ? k(s, p) ? "replace" : r : "remove";
            if (v !== w || A !== "replace") {
              var O = f.concat(p);
              c.push(A === "remove" ? { op: A, path: O } : { op: A, path: O, value: w }), i.push(A === r ? { op: "remove", path: O } : A === "remove" ? { op: r, path: O, value: t(v) } : { op: "replace", path: O, value: t(v) });
            }
          });
        }(n, o, a, u);
      case 5:
      case 1:
        return function(l, f, c, i) {
          ...
          for (var w = 0; w < s.length; w++)
            if (h[w] && p[w] !== s[w]) {
              var A = f.concat([w]);
              c.push({ op: "replace", path: A, value: t(p[w]) }), i.push({ op: "replace", path: A, value: t(s[w]) });
            }
          for (var O = s.length; O < p.length; O++) {
            var R = f.concat([O]);
            c.push({ op: r, path: R, value: t(p[O]) });
          }
          s.length < p.length && i.push({ op: "replace", path: f.concat(["length"]), value: s.length });
        }(n, o, a, u);
      case 3:
        return function(l, f, c, i) {
          var s = l.t, h = l.o, p = 0;
          s.forEach(function(d) {
            if (!h.has(d)) {
              var v = f.concat([p]);
              c.push({ op: "remove", path: v, value: d }), i.unshift({ op: r, path: v, value: d });
            }
            p++;
          }), p = 0, h.forEach(function(d) {
            if (!s.has(d)) {
              var v = f.concat([p]);
              c.push({ op: r, path: v, value: d }), i.unshift({ op: "remove", path: v, value: d });
            }
            p++;
          });
        }(n, o, a, u);
    ...
    a.push({ op: "replace", path: [], value: o === me ? void 0 : o }), u.push({ op: "replace", path: [], value: n });
  } });
}
var Le;
var F;
var we = typeof Symbol < "u" && typeof Symbol("x") == "symbol";
var it = typeof Map < "u";
var ut = typeof Set < "u";
var je = typeof Proxy < "u" && Proxy.revocable !== void 0 && typeof Reflect < "u";
var me = we ? Symbol.for("immer-nothing") : ((Le = {})["immer-nothing"] = true, Le);
var J = we ? Symbol.for("immer-draftable") : "__$immer_draftable";
var _ = we ? Symbol.for("immer-state") : "__$immer_state";
var ct = { 0: "Illegal state", 1: "Immer drafts cannot have computed properties", 2: "This object has been frozen and should not be mutated", 3: function(e) {
...
var Oe = typeof Reflect < "u" && Reflect.ownKeys ? Reflect.ownKeys : Object.getOwnPropertySymbols !== void 0 ? function(e) {
  return Object.getOwnPropertyNames(e).concat(Object.getOwnPropertySymbols(e));
} : Object.getOwnPropertyNames;
var ft = Object.getOwnPropertyDescriptors || function(e) {
  var t = {};
...
var se = { get: function(e, t) {
  ...
  return ne(e.t, t) !== void 0 || t in e.t ? (e.D[t] = false, oe(e), ie(e)) : delete e.D[t], e.o && delete e.o[t], true;
...
C(se, function(e, t) {
  ...
  return {}.NODE_ENV !== "production" && isNaN(parseInt(t)) && g(13), x.set.call(this, e, t, void 0);
...
var lt = function() {
  function e(r) {
    var n = this;
    this.g = je, this.F = true, this.produce = function(o, a, u) {
      if (typeof o == "function" && typeof a != "function") {
        ...
        return function(v) {
          ...
          return f.produce(v, function(ee) {
            var _e;
            return (_e = a).call.apply(_e, [w, ee].concat(O));
          });
        };
      }
      var c;
      if (typeof a != "function" && g(6), u !== void 0 && typeof u != "function" && g(7), S(o)) {
        var i = Se(n), s = ue(n, o, void 0), h = true;
        try {
          c = a(s), h = false;
        } finally {
          h ? W(i) : ae(i);
        }
        return typeof Promise < "u" && c instanceof Promise ? c.then(function(v) {
      ...
      if (!o || typeof o != "object") {
        if ((c = a(o)) === void 0 && (c = o), c === me && (c = void 0), n.F && ye(c, true), u) {
          var p = [], d = [];
          T("Patches").M(o, c, p, d), u(p, d);
        }
        return c;
      }
      g(21, o);
      ...
      if (typeof o == "function")
        return function(c) {
          for (var i = arguments.length, s = Array(i > 1 ? i - 1 : 0), h = 1; h < i; h++)
            s[h - 1] = arguments[h];
          return n.produceWithPatches(c, function(p) {
            return o.apply(void 0, [p].concat(s));
          });
        };
      var u, l, f = n.produce(o, a, function(c, i) {
        u = c, l = i;
      });
...
function dt(e, t = {}) {
  ...
  return createSlice({
    ...
    reducers: {
      addMetadata(f, c) {
        const { id: i, meta: s } = c.payload, h = f.nodes[i].meta, p = Object.keys(s).reduce((d, v) => (d[v] || (d[v] = []), d[v].push({
          type: v,
          id: N.get(),
          val: s[v],
          createdOn: Date.now()
        }), d), h);
        f.nodes[c.payload.id].meta = p;
      },
      addArtifact(f, c) {
        f.nodes[c.payload.id].artifacts.push({
          id: N.get(),
          createdOn: Date.now(),
          val: c.payload.artifact
        });
      },
      changeCurrent(f, c) {
        f.current = c.payload;
      ...
      addNode(f, { payload: c }) {
        f.nodes[c.id] = c, f.nodes[c.parent].children.push(c.id), f.current = c.id;
      },
      load(f, { payload: c }) {
        return c;
      }
...
function ht(e) {
  const t = /* @__PURE__ */ new Map(), { reducer: r, actions: n, getInitialState: o } = dt(e), a = createListenerMiddleware();
  a.startListening({
    matcher: isAnyOf(n.changeCurrent, n.addNode),
    effect: (l, f) => {
      f.cancelActiveListeners(), t.forEach((c) => {
        const i = isAnyOf(n.addNode)(l), { skipOnNew: s } = c.config;
        s && i || c.func(i ? "new" : "traversal");
      });
    }
  });
  const u = configureStore({
    reducer: r,
  ...
  return {
    ...
    currentChange(l, f) {
      ...
      return t.set(c.id, c), () => t.delete(c.id);
    },
    update: u.dispatch,
    ...n
  };
...
function j(e, t, r, n, o, a) {
  if (r === void 0 && (r = false), n === void 0 && (n = true), o === void 0 && (o = true), a === void 0 && (a = 0), r && (typeof r == "function" ? r(t, 0, e, t.path) : q(t, 0)), t.path === "") {
    var u = { newDocument: e };
    if (t.op === "add")
    ...
    if (t.op === "test") {
      if (u.test = K(e, t.value), u.test === false)
    ...
    n || (e = E(e));
    var l = t.path || "", f = l.split("/"), c = e, i = 1, s = f.length, h = void 0, p = void 0, d = void 0;
    for (typeof r == "function" ? d = r : d = q; ; ) {
      ...
      if (r && h === void 0 && (c[p] === void 0 ? h = f.slice(0, i).join("/") : i == s - 1 && (h = t.path), h !== void 0 && d(t, 0, e, h)), i++, Array.isArray(c)) {
        if (p === "-")
          p = c.length;
        else {
          if (r && !pe(p))
  ...
  if (U[e.op]) {
    ...
    if (r) {
      if (e.op == "add") {
        ...
        var u = { op: "_get", path: e.from, value: void 0 }, l = xe([u], r);
...
function Tt(e, t) {
  ...
  return n.patches = r, n.object = e, n.unobserve = function() {
    he(n), clearTimeout(n.next), Pt(o, n), typeof window < "u" && (window.removeEventListener("mouseup", l), window.removeEventListener("keyup", l), window.removeEventListener("mousedown", l), window.removeEventListener("keydown", l), window.removeEventListener("change", l));
...
function Ee(e, t, r, n, o) {
  if (t !== e) {
    ...
    for (var a = le(t), u = le(e), l = false, f = u.length - 1; f >= 0; f--) {
      var c = u[f], i = e[c];
      if (fe(t, c) && !(t[c] === void 0 && i !== void 0 && Array.isArray(t) === false)) {
        var s = t[c];
        typeof i == "object" && i != null && typeof s == "object" && s != null && Array.isArray(i) === Array.isArray(s) ? Ee(i, s, r, n + "/" + L(c), o) : i !== s && (o && r.push({ op: "test", path: n + "/" + L(c), value: E(i) }), r.push({ op: "replace", path: n + "/" + L(c), value: E(s) }));
      } else
        Array.isArray(e) === Array.isArray(t) ? (o && r.push({ op: "test", path: n + "/" + L(c), value: E(i) }), r.push({ op: "remove", path: n + "/" + L(c) }), l = true) : (o && r.push({ op: "test", path: n, value: e }), r.push({ op: "replace", path: n, value: t }));
    }
    if (!(!l && a.length == u.length))
      for (var f = 0; f < a.length; f++) {
        var c = a[f];
        !fe(e, c) && t[c] !== void 0 && r.push({ op: "add", path: n + "/" + L(c), value: E(t[c]) });
      }
  }
}
function ze(e, t, r) {
...
var z = ((e) => (e.TRAVERSAL_START = "Traversal_Start", e.TRAVERSAL_END = "Traversal_End", e))(z || {});
function $(e, t) {
  const r = e.state;
  ...
  a.shift();
  const u = a.map((c) => t[c]).map((c) => c.state.val).reduce((c, i) => [...c, ...i], []), l = $(o, t);
  return V(
    l,
    E(u),
    true,
...
function Ut({
  ...
  const u = {
    ...
    latestOfType(i, s = o.current.id) {
      var _a;
      return (_a = o.backend.nodes[s].meta[i]) == null ? void 0 : _a.at(-1);
    },
    allOfType(i, s = o.current.id) {
      return o.backend.nodes[s].meta[i];
    },
    latest(i = o.current.id) {
      const s = o.backend.nodes[i].meta, h = Object.keys(s).reduce(
        (p, d) => {
          const v = s[d].at(-1);
          return v && (p[d] = v), p;
        },
    ...
    add(i, s = o.current.id) {
      u.add({ annotation: i }, s);
    },
    latest(i = o.current.id) {
      var _a;
      return (_a = u.latestOfType("annotation", i)) == null ? void 0 : _a.val;
    },
    all(i = o.current.id) {
      var _a;
      return (_a = u.allOfType("annotation", i)) == null ? void 0 : _a.map((s) => s.val);
    }
  }, c = {
    add(i = o.current.id) {
      u.add({ bookmark: true }, i);
    },
    remove(i = o.current.id) {
      u.add({ bookmark: false }, i);
    },
    is(i = o.current.id) {
      var _a;
      return Boolean(
        (_a = u.latestOfType("bookmark", i)) == null ? void 0 : _a.val
      );
    },
    toggle(i = o.current.id) {
      c.is(i) ? c.remove(i) : c.add(i);
    }
  };
  return {
    registry: e,
    ...
    async apply(i, s) {
      const h = e.get(s.type), p = $(
        this.current,
        this.graph.backend.nodes
      );
      if (h.config.hasSideEffects) {
        const { do: d = s, undo: v } = h.func(s.payload);
        this.record({
          label: i,
          state: p,
          sideEffects: { do: [d], undo: [v] },
          eventType: h.config.eventType
        });
      } else {
        const d = h.func(p, s.payload);
        this.record({
          label: i,
          state: d,
          sideEffects: { do: [], undo: [] },
    ...
    async to(i) {
      ...
      for (let p = 0; p < s.length - 1; ++p) {
        const d = a(s[p]), v = a(s[p + 1]);
        It(d, v) ? P(d) && h.push(
          ...d.sideEffects.undo
        ) : P(v) && h.push(...v.sideEffects.do);
      }
      for (const p of h) {
        const d = e.get(p.type).func;
        await d(p.payload);
      }
    ...
    undo() {
      const { current: i } = o;
      return P(i) ? this.to(i.parent) : Promise.resolve(console.warn("Already at root!"));
    },
    redo(i = "latest") {
      const { current: s } = o;
      return s.children.length > 0 ? this.to(
        s.children[i === "oldest" ? 0 : s.children.length - 1]
      ) : Promise.resolve(
        console.warn("Already at latest in this branch!")
      );
    },
    currentChange(i, s = false) {
    ...
    import(i) {
      const s = JSON.parse(i), h = s.current;
      s.current = s.root, o.update(o.load(s)), this.to(h);
    },
    importObject(i) {
      const s = i.current;
      i.current = i.root, o.update(o.load(i)), this.to(s);
    },
    metadata: u,
    artifact: l,
    annotations: f,
...
function Rt(e, t, r) {
  ...
  if (n.id === o.id)
    return n.id;
  for (; n.id !== o.id; )
    P(n) && (n = r[n.parent]), P(o) && (o = r[o.parent]);
  return n.id;
}
function Je(e, t, r) {
  const n = Rt(e, t, r), o = r[n], a = [], u = [];
  let [l, f] = [e, t];
  for (; l.id !== o.id; )
    a.push(l), P(l) && (l = r[l.parent]);
  for (a.push(l); f.id !== o.id; )
    u.push(f), P(f) && (f = r[f.parent]);
  const c = u.reverse();
  return [...a, ...c].map((i) => i.id);
}
function It(e, t) {
  if (P(e) && e.parent === t.id)
    return true;
  if (P(t) && t.parent === e.id)
    return false;
  throw new Error(
