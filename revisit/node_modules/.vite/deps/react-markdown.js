...
var VFile2 = class {
  ...
  constructor(value) {
    ...
    if (!value) {
      options = {};
    } else if (typeof value === "string" || (0, import_is_buffer2.default)(value)) {
      options = { value };
...
function tokenizeHtmlFlow(effects, ok3, nok) {
  ...
  function declarationStart(code2) {
    ...
    if (code2 === codes.leftSquareBracket) {
      ...
      buffer3 = constants.cdataOpeningString;
      index2 = 0;
  ...
  function cdataOpenInside(code2) {
    if (code2 === buffer3.charCodeAt(index2++)) {
      effects.consume(code2);
      return index2 === buffer3.length ? self.interrupt ? ok3 : continuation : cdataOpenInside;
    }
    return nok(code2);
  }
  ...
  function tagName(code2) {
    if (code2 === codes.eof || code2 === codes.slash || code2 === codes.greaterThan || markdownLineEndingOrSpace(code2)) {
      if (code2 !== codes.slash && startTag && htmlRawNames.includes(buffer3.toLowerCase())) {
  ...
  function continuationRawEndTag(code2) {
    if (code2 === codes.greaterThan && htmlRawNames.includes(buffer3.toLowerCase())) {
      effects.consume(code2);
      return continuationClose;
    }
  ...
  const config = configure(
    {
      ...
      enter: {
        ...
        htmlFlow: opener(html3, buffer3),
        htmlFlowData: onenterdata,
        htmlText: opener(html3, buffer3),
...
function toReact(context, node, index2, parent) {
  ...
  if (node.properties) {
    for (property in node.properties) {
      if (own6.call(node.properties, property)) {
